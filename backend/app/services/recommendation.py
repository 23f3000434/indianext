...
class RecommendationEngine:
    ...
    _RECOMMENDATIONS: Dict[str, List[Dict[str, Any]]] = {
        ...
        "deepfake": [
            {
                "action": "Do not trust this image at face value",
                "priority": "immediate",
                "description": (
                    "This image shows signs of manipulation or AI generation. Do not "
            ...
            {
                "action": "Verify the source of this image",
                "priority": "high",
                "description": (
                    "Trace the origin of this image back to its original source. Check "
            ...
            },
            {
                ...
                "priority": "high",
                "description": (
                    "If this image was found on a social media platform or website, "
    ...
    def generate_recommendations(
        ...
        pool = self._RECOMMENDATIONS.get(threat_type, [])
